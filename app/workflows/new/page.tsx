...
export default function CreateWorkflowPage() {
  ...
  const [scheduleCron, setScheduleCron] = React.useState("0 9 * * *")
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await automationsApi.create({
        ...
        schedule_cron: isSchedule ? scheduleCron.trim() : null,
        schedule_timezone: isSchedule ? scheduleTimezone.trim() || null : null,
      })
            ...
            <CardContent className="pt-2">
              <WorkflowFlowBuilder
                ...
                triggerLabel={
                  ...
                  (triggerEvent || "Choose a trigger above")
                }
              />
            </CardContent>
          </Card>
